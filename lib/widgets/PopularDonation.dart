...
import 'package:giveaway/Animations/ScaleRoute.dart';
import 'DonationDetailsPage.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_core/firebase_core.dart';
import 'package:geolocator/geolocator.dart';

class PopularDonationsWidget extends StatefulWidget {
  @override
  _PopularDonationsWidgetState createState() => _PopularDonationsWidgetState();
}

class _PopularDonationsWidgetState extends State<PopularDonationsWidget> {
  @override
    ...
    s.forEach((element) {
      element.docs.forEach((element) {
        ...
        Geolocator()
            ...
            .then((value) => {
                  if ((value / 1000).round() < 25 && elt['Benefactor'] == null)
                    {
                      setState(() {
